# file này chỉ chứa cheat sheet về cách query trong Django, ko lquan tới project
# để thực hiện các query này, bật shell "python manage.py shell"
#------------------------------------------------
...
#(4)Returns single customer by name (query theo thuộc tính)
